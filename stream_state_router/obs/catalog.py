...
class OBSResourceCatalog:
    ...
    def summary(self) -> dict[str, object]:
        return {
            ...
            "unreadable_containers": sorted(self.unreadable_containers, key=str.casefold),
        }
...
class OBSResourceCatalogReader:
    ...
    def sync(self) -> OBSResourceCatalog:
        ...
        pending_groups = list(sorted(group_names, key=str.casefold))
        while pending_groups:
            ...
            for nested in sorted(nested_groups, key=str.casefold):
                if nested not in visited_groups and nested not in pending_groups:
        ...
        groups = tuple(sorted(visited_groups | group_names, key=str.casefold))
